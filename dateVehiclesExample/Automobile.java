...
public class Automobile extends Vehicles{
	...
	public Automobile(TypeOption type, LocalDate year, String model, int km, LocalDate inspectionDate,
	...
	public void doInspection() {
		if(inspectionDateIsPass()) {
			...
			System.out.println("You have" + remainingTimeNextInspection() + " day to next car inspection.");
